...
save_path = '../models/soil_nutritionv2'
...
def load_model(model_name):
    if model_name == "Plant disease":
        ...
        model = YOLO(r'..\models\train43\weights\best.pt')
        processor = None
    elif model_name == "YOLO":
        model = YOLO(r'..\models\train11\weights\best.pt')
        processor = None
    elif model_name == "mango":
        model = YOLO(r'..\models\train51\weights\best.pt')
        processor = None
...
def home_page():
    ...
    st.image("..\\templates\\Pictures\\Home page\\Gemini_Generated_Image_h7i8v7h7i8v7h7i8.jpeg")
    st.markdown("""
