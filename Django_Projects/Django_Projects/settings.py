...
# Loading environment variables from .env.example file
load_dotenv()
...
SECRET_KEY = 'django-insecure-4qwx9xt6h$ql=^=((0=y38n7(%dcic2v*r*!^g*4+r*b1vyoh4'
...
# for testing whether the Allowed hosts is working or not
